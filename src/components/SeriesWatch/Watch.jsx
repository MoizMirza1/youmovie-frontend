      ...
      {!isTrailerOpen && (
        <div className="relative z-10 flex flex-col justify-end items-start px-8 md:px-16 h-full pb-28">
          ...
          <div className="flex items-center space-x-6 mt-3 text-gray-300 text-sm md:text-base">
            ...
            <div className="flex items-center space-x-1"><FaClock className="text-white text-lg" /><span>{series.episode_run_time[0]} min</span></div>
            <div className="flex items-center space-x-1"><FaCalendarAlt className="text-white text-lg" /><span>{series.first_air_date}</span></div>
          </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-4">
          <div className="bg-gray-900 text-white p-8 rounded-lg w-[700px] max-w-full">
            ...
            <p className="text-gray-400 text-base mb-4">
              <strong>Language:</strong> {series.original_language.toUpperCase()}
            </p>
